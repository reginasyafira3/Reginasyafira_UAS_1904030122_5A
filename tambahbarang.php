        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="experience">
                <div class="resume-section-content">
                    <h2 class="mb-5">Tambah Data Barang</h2>
                    <div class="card shadow mb-12">
                            ...
                            <?php
                                ...
                                if(isset($_POST['btnSimpan'])) {
                                    ...
                                    $sql = "INSERT INTO tb_barang (nama_barang, harga_barang, stok_barang, foto_barang 
                                     ) VALUES ('$nama_barang', '$harga_barang', '$stok_barang', '$foto_barang')";
                                        ...
                                        if($qryInsert){
                                            ...
                                            <?php
                                            echo "<meta http-equiv='refresh' content='0; url=tambahbarang.php'>";
                                        } 
